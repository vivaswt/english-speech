...
class WebArticleProcessorScreen extends StatefulWidget {
  const WebArticleProcessorScreen({super.key});

  @override
  State<WebArticleProcessorScreen> createState() =>
      _WebArticleProcessorScreenState();
}

class _WebArticleProcessorScreenState extends State<WebArticleProcessorScreen> {
