import 'package:english_speech/batch/youtube_subtitle.dart';
import 'package:english_speech/google/youtube.dart';
import 'package:flutter/material.dart';

class YouTubeSubtitlesRegistScreen extends StatefulWidget {
  const YouTubeSubtitlesRegistScreen({super.key});

  @override
  State<StatefulWidget> createState() => _YouTubeSubtitlesRegistScreenState();
}

class _YouTubeSubtitlesRegistScreenState
    extends State<YouTubeSubtitlesRegistScreen> {
  late final YouTubeSubtitleBatch _batch;

  @override
  void initState() {
    super.initState();
    _batch = YouTubeSubtitleBatch();
      ...
      appBar: AppBar(
        title: const Row(
          children: [
            ...
            SizedBox(width: 8),
            Text('Convert YouTube Videos to Web Articles'),
          ],
        ),
      ),
      body: Column(
